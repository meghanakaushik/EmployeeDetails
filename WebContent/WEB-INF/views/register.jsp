...
input[type=id], input[type=employeeID] {
  width: 100%;
  padding: 15px;
  margin: 5px 0 22px 0;
...
<form action="registerpage" method=post >
 ...
 <div class="container">
    ...
    <hr>
     ...
     <input type="id" placeholder="Enter ID" name="employeeID" required>
    ...
    <input type="text" placeholder="Enter Address" name="employeeAddress" required>
